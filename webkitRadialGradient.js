//                              Author: Fylyppova Irina H.
//                            Автор: Филиппова Ірина Гаріївна
//                                        Харків
// ---------------------------------------------------------------------------------
//                       Returns webkit radial gradient (string)
//                     (webkit radial gradient doesn't work in IE) 
//   Params:
//       objectRadis - the size of html element with gradient background
//       mainColorIndexes: 0 - red; 1 - green; 2 - blue; 
//                        [0,1] - yellow; [0,2] - magenta; [1,2] - cyan
//       lightFrom: center_center,
